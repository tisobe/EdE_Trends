...
#########################################################################################
#											#
#	ede_oba_example.perl: plot OBA temperature - EdE relationship example (oobthr53)#
#											#
...
#
open(FH, "/data/mta_www/mta_grat/EdE_trend/OBA/ACIS_MTG_1022/oobthr53_out");
while(<FH>){
       	chomp $_;
       	@atemp = split(/\s+/, $_);
       	push(@xbin, $atemp[0]);
...
#
#---- fit a line with reboust method
#
...
pgptxt($xmid, $ybot, 0.0, 0.5, "Temperature (C)");
pgptxt($xside, $ymid, 90, 0.5, "E/dE");
